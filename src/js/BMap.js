...
;(function() {
  var fBMap = {
    ...
    config: {
      ...
      baiduWindowContent:
        "<div >蓝光林肯<br>地址：dgsgdsg<br>电话：13298987676</div>" +
        "<div><a href='www.baidu.com' target='_blank'><img src='http://img11.soufunimg.com/viewimage/house/2017_07/26/M18/0B/70/ChCE4Fl4U-OIYGxzAAeIn4mgtnUAAne4AJGLroAB4i3224/232x162.jpg'></a></div>",
      infoBoxmb:
    ...
    creatMapObj: function(div, option) {
      ...
      // var infoWindow = new BMap.InfoWindow(fBMap.infoBoxmb) // 创建信息窗
    ...
    selfAdd: function(mp, option) {
      ...
      ComplexCustomOverlay.prototype.initialize = function(map) {
        ...
        var data = {
          ...
          img:'http://upload.fdc.com.cn/2017/1211/1512954134639.jpg',
          point:self._point,     
        }
        var contentCustom = _this.formatTemplate(data, fBMap.config.infoBoxmb);
        var infoW = new BMapLib.InfoBox(map, contentCustom, opts)
      
        div.onclick = function() {
          infoW.open(self._point)
        }

        _this.clickmarker(div, self._point, infoW ) 
        
        _this.clickmarker($('[data-map="custom"]')[0], self._point, infoW) 
        _this.clickmarker($('[data-map="custom"]')[1], self._point, infoW) 

          
      
        mp.getPanes().labelPane.appendChild(div)
        // _this.addMarker(map, this._point, this.infoW, 0, 0, 00)
        return div
      }
      ...
      if (lng && lat) {
        ...
        // var infoWindow = new BMap.InfoWindow(fBMap.infoBoxmb) // 创建信息窗口对象
